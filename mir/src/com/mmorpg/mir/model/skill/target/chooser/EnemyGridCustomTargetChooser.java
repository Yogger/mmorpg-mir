...
@Component
public class EnemyGridCustomTargetChooser extends AbstractTargetChooser {
	...
	public void useSkill(Player player, int skillId, long targetId, int x, int y, long[] targetList, byte direction) {
		...
		player.getController().useSkill(skillId, targetId, x, y, (Creature) object, null, direction);
	}
