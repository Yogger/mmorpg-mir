...
public class ConsumeRankElement extends RankRow {
	...
	public static ConsumeRankElement valueOf(Player player) {
		ConsumeRankElement e = new ConsumeRankElement();
		e.objId = player.getObjectId();
		e.name = player.getName();
		e.score = player.getOpenActive().getConsumeActive().getConsumeGold();
	...
	public int compareTo(RankRow o) {
		ConsumeRankElement element = (ConsumeRankElement) o;
