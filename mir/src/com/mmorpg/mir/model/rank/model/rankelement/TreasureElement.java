...
public class TreasureElement extends RankRow {
	...
	public static TreasureElement valueOf(Player player) {
		TreasureElement e = new TreasureElement();
		...
		e.level = player.getCombatSpiritStorage().getCombatSpiritCollection()
				.get(CombatSpiritType.TREASURE.getValue())
				.getCombatResourceId();
	...
	public int compareTo(RankRow o) {
		TreasureElement other = (TreasureElement) o;
