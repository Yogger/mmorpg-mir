...
public class ThousandConsumeRankElement extends RankRow {
	...
	public static ThousandConsumeRankElement valueOf(Player player) {
		ThousandConsumeRankElement e = new ThousandConsumeRankElement();
		e.objId = player.getObjectId();
		e.name = player.getName();
		e.country = player.getCountryValue();
		e.score = player.getCommonActivityPool().getConsumeActives().get("THOUSAND_CONSUME").getConsumeGold();
	...
	public int compareTo(RankRow o) {
		ThousandConsumeRankElement element = (ThousandConsumeRankElement) o;
