...
public class MergeConsumeElement extends RankRow {
	...
	public static MergeConsumeElement valueOf(Player player) {
		MergeConsumeElement e = new MergeConsumeElement();
		e.objId = player.getObjectId();
		e.name = player.getName();
		e.score = player.getMergeActive().getConsumeCompete().getConsumeGold();
	...
	public int compareTo(RankRow o) {
		MergeConsumeElement element = (MergeConsumeElement) o;
