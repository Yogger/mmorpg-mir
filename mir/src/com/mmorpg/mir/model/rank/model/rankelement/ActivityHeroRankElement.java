...
public class ActivityHeroRankElement  extends RankRow{
	...
	public static ActivityHeroRankElement valueOf(Player player) {
		ActivityHeroRankElement e = new ActivityHeroRankElement();
		...
		e.count = player.getOpenActive().getCountryHeroActive().getKillNums();
	...
	public int compareTo(RankRow o) {
		ActivityHeroRankElement other = (ActivityHeroRankElement) o;
