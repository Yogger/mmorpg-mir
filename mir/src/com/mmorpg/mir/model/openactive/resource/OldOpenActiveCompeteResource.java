...
@Resource
public class OldOpenActiveCompeteResource {
	
	public static final String COMPETE_RANK_TYPE = "RankType";
	...
	/** 奖励是否可以即时领取 */
	private boolean instanceCanRecieve;
	...
	public boolean isInstanceCanRecieve() {
		return instanceCanRecieve;
	}

	public void setInstanceCanRecieve(boolean instanceCanRecieve) {
		this.instanceCanRecieve = instanceCanRecieve;
	}
