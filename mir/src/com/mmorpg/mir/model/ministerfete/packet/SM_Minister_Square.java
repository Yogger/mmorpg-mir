...
public class SM_Minister_Square {
	/** 自己的活动数据 */
	...
	public static SM_Minister_Square valueOf(TechCopyRankVO selfVO, TechCopyRankVO lastAttack, ArrayList<TechCopyRankVO> ranks, long t) {
		SM_Minister_Square sm = new SM_Minister_Square();
		sm.endTime = t;
		sm.selfVO = selfVO;
		sm.ranks = ranks;
