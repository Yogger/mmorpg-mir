...
import com.mmorpg.mir.model.ai.desires.impl.AggressionRouteWalkDesire;
...
public class RouteActiveAggroStateHandler implements IStateHandler {
	@Override
	...
	public void handleState(AIState state, AI ai) {
		...
		if (owner.hasRouteStep() && owner.canMove()) {
			ai.addDesire(new AggressionRouteWalkDesire(owner, AIState.ACTIVE.getPriority()));
		} else {
			int creatureCount = 0;
