...
//			SubModuleType.INVEST_RELIVEDAN_BUY),
	...
	private InvestAgateType(int type, int errorCode, SubModuleType rewardSubmodule, SubModuleType actSubmodule) {
		this.type = type;
	...
	public static InvestAgateType typeOf(int type) {
		for (InvestAgateType t : InvestAgateType.values()) {
			if (t.type == type) {
				return t;
			}
		}
