...
public class SM_TechCopy_End {
	...
	public static SM_TechCopy_End valueOf(TechCopyRankVO selfVO, TechCopyRankVO lastAttack, ArrayList<TechCopyRankVO> ranks, long t) {
		SM_TechCopy_End sm = new SM_TechCopy_End();
		sm.endTime = t;
		sm.selfVO = selfVO;
		sm.ranks = ranks;
