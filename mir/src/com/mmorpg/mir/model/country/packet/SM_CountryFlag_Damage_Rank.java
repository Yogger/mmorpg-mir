...
public class SM_CountryFlag_Damage_Rank {

	private Map<Integer, CountryNpcDamageVO> rankMap;
	private long killTime;
	private byte hitCountry;

	public static SM_CountryFlag_Damage_Rank valueOf(Map<Integer, CountryNpcDamageVO> ranks, long time, int countryValue) {
		SM_CountryFlag_Damage_Rank sm = new SM_CountryFlag_Damage_Rank();
		sm.rankMap = ranks;
		sm.killTime = time;
