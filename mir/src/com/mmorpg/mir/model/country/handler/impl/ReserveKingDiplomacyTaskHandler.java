...
import com.mmorpg.mir.model.country.event.ReserveKingFinishDiplomacyEvent;
...
@Component
public class ReserveKingDiplomacyTaskHandler extends AbstractReserveKingTaskHandler {
	...
	public ReserveTaskEnum getTaskType() {
		return ReserveTaskEnum.KILL_DACHEN;
	}

	@ReceiverAnno
	public void reveiveEvent(ReserveKingFinishDiplomacyEvent event) {
