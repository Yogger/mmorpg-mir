...
public class SM_SmeltEquipment_Horse {
	...
	public static SM_SmeltEquipment_Horse valueOf(int type, ItemStorage storage, int code, long returnTotoalAddValue,
			Map<Integer, SmeltVO> log) {
		SM_SmeltEquipment_Horse sm = new SM_SmeltEquipment_Horse();
		sm.type = type;
