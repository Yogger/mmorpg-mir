...
public class FirstPayCountCondition extends AbstractCoreCondition {
	private Operator op;
	private int low;
	private int high;
	...
	public boolean verify(Object object) {
		...
		int count = Long.valueOf(player.getCommonActivityPool().getFirstPays().get(code).getPayCount()).intValue();
		if (count == -1) {
			return false;
		}
		if (op != null) {
